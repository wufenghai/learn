package com.example.learn.framework.common.exception.util;
 ...
 * <p>
 * 1. 异常提示信息，写在枚举类中，例如说，user.api.constants.ErrorCodeEnum 类 + ServiceExceptionConfiguration
...
public class ServiceExceptionUtil {
    ...
    public static ServiceException exception(ErrorCode errorCode) {
        //如果存在key, 则返回其对应的value, 否则返回给定的默认值
